...
export const CLI_COMMAND_DESCRIPTIONS: Record<CliCommand, string> = {
  ...
  [CLI_COMMANDS.IMPACT]: "Get blast radius for a symbol",
...
export function getUsageText(): string {
  return [
    ...
    `  docuvia ${(CLI_COMMANDS.IMPACT + " <target> [--escalateToLsp]").padEnd(40)} # ${CLI_COMMAND_DESCRIPTIONS[CLI_COMMANDS.IMPACT]}`,
