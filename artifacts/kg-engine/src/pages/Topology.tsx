...
const DECISION_COLOR = "#E8B931";

type SimNode = TopologyNode & SimulationNodeDatum;
type SimLink = SimulationLinkDatum<SimNode> & Pick<TopologyLink, "linkType" | "confidence">;
...
function nodeRadius(n: SimNode, maxDegree: number): number {
