...
*Note: This journey focuses on the three-gate UX and the distinction from the chat `/extract` command. The underlying extraction mechanism is shared with Journey H.*
