# PHP CLI Benchmark & AST Analysis Report

> **Purpose:** This document defines the evaluation matrix, execution results, and metrics for PHP target repositories.

---

## 🔍 Target Projects

- **Project 1**: `laravel/framework`
- **Project 2**: `WordPress/WordPress`

---

## 1. Project 1: `laravel/framework` Benchmark
...
## 2. Project 2: `WordPress/WordPress` Benchmark
