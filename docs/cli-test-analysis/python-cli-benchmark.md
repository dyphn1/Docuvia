# Python CLI Benchmark & AST Analysis Report

> **Purpose:** This document defines the evaluation matrix, execution results, and metrics for Python target repositories.

---

## 🔍 Target Projects

- **Project 1**: `django/django`
- **Project 2**: `fastapi/fastapi`

---

## 1. Project 1: `django/django` Benchmark
...
## 2. Project 2: `fastapi/fastapi` Benchmark
