# Ruby CLI Benchmark & AST Analysis Report

> **Purpose:** This document defines the evaluation matrix, execution results, and metrics for Ruby target repositories.

---

## 🔍 Target Projects

- **Project 1**: `rails/rails`
- **Project 2**: `discourse/discourse`

---

## 1. Project 1: `rails/rails` Benchmark
...
## 2. Project 2: `discourse/discourse` Benchmark
