...
| **KnowledgeStore**              | The singleton service (`KnowledgeStore.ts`) in the VS Code extension that manages the in-memory snapshot of the `.docuvia/local.db` SQLite database and syncs changes to disk. Acts as the Model layer of the VS Code extension.                                                                                                                                          |
