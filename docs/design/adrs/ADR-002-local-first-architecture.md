...
- **Architecture Recovery**: Falls back to Depth-2 topology scanning and `git log -n 100` (implemented in [`artifacts/vscode-client/src/KnowledgeStore.ts`](../../../artifacts/vscode-client/src/KnowledgeStore.ts)).
