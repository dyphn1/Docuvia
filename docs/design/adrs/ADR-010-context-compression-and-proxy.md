...
- The proxy replaces the code with an ID and injects a System Prompt: *"Some code blocks have been compressed. Use the `docuvia_retrieve_original` MCP tool with the ID to read the full code."*
