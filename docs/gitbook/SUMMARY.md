...
- [ADR-027: Sub-second Incremental Watch](adr/ADR-027-sub-second-incremental-watch.md)
- [ADR-028: Semantic Deduplication in Agentic RAG](adr/ADR-028-semantic-deduplication-in-agentic-rag.md)
- [ADR-029: Local Vector Index and Natural Language UI](adr/ADR-029-local-vector-index-and-natural-language-ui.md)
