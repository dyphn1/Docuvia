...
> **Note:** The legacy decision log (originally arc42 chapter 9) has been archived to prevent numbering conflicts with the modern ADR list. Concepts from the legacy log (e.g. Three-Tier Knowledge Graph, Orphan Git Branch) are documented within the corresponding system architecture pages.
