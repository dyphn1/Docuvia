...
| [IFCE-007](IFCE-007-docuvia-skill-set.md)                | docuvia-* Skill Set                                | accepted -- implemented | Task-routed agent guidance files, installed via `init --skills`, removed via `uninstall --skills`        |
