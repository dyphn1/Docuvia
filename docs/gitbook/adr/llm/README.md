...
- Multi-Provider LLM Abstraction Layer (Task #7)

## Decisions

| ID | Decision | Status | Notes |
|----|----------|--------|-------|
| [LLM-001](LLM-001-multi-provider-abstraction.md) | Multi-Provider Abstraction Layer | proposed | Carries forward legacy ADR-026 (Corresponds to Task #7) |
