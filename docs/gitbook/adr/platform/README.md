...
| [PLAT-007](PLAT-007-tiered-background-knowledge-evolution.md)  | Tiered Background Knowledge Evolution        | accepted | Implements PLAT-004's delta promise + IMPT-002's tri-layer: per-commit AST delta (`analyze` auto mode), debounced LSP batch + snapshot, budgeted LLM L3 queue; no new commands |
