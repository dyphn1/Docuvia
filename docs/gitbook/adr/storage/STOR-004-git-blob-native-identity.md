...
*(Note: The second phase of this proposal—using the git branch itself as a content-addressable object store for team-wide sharing—is currently deferred pending a cost/benefit analysis).*
