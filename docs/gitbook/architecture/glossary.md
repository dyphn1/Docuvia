...
- [08-crosscutting-concepts.md](./crosscutting-concepts.md#81-domain-model) — Full domain model entity-relationship diagram
- [05-building-blocks.md](./building-blocks.md#54-level-2--db-package-schemas) — Full schema table list
