...
Welcome to the Coding Guidelines for **Docuvia2**.

While the [System Architecture](../architecture/README.md) defines _how_ the different parts of the system interact, these guidelines define _how the code itself_ should be written and organized.

As an AI Agent or Developer contributing to this repository, you are expected to internalize these rules to ensure the codebase remains clean, maintainable, and strictly aligned with our architectural vision.
...
- **[Phase-Based Test Quality Hardening](phase-based-test-quality-hardening.md)**: How to baseline, score, strengthen, and close one test-quality phase at a time. Every scored contract must reach at least 80; 90+ is the preferred target.
