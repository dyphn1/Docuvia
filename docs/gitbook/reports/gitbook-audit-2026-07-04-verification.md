...
| ID               | Issue                                                                                                                                                                                                                                                                   | Next step                                                                                                                                                                                                           |
| ---------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `1.4`            | Git-level rename detection (`-M` flag) works, but DB layer (`ast-change-detector.ts`, `project-files` schema) has no `oldPath` column and treats renames as fresh INSERTs.                                                                                              | Decide scope: if DB-level rename tracking is desired, add `oldPath` column + UPDATE-on-rename logic; otherwise close as working-as-intended and reword the finding.                                                 |
