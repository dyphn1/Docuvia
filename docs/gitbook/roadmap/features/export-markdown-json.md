...
- **Evidence / Verification Target**: `artifacts/api-server/src/services/export.service.ts`

## Implementation Details

This feature is anchored by the following core components:

[`artifacts/api-server/src/services/export.service.ts`](../../../../artifacts/api-server/src/services/export.service.ts)
