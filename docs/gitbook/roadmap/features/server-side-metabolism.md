# Server-Side Metabolism

- **Status**: ✅ Done
- **Phase**: Phase 1: Core API & Database (The Metabolism Engine)
- **Evidence / Verification Target**: `artifacts/api-server/src/routes/metabolism.ts`

## Implementation Details

This feature is anchored by the following core components:

[`artifacts/api-server/src/routes/metabolism.ts`](../../../../artifacts/api-server/src/routes/metabolism.ts)
