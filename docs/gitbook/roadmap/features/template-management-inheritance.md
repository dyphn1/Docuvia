...
- **Evidence / Verification Target**: `lib/core/src/services/prompt-service.ts` — no true inheritance model

## Implementation Details

This feature is anchored by the following core components:

[`lib/core/src/services/prompt-service.ts`](../../../../lib/core/src/services/prompt-service.ts) — no true inheritance model
