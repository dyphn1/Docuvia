...
| AST Plugin Architecture                  | ⚠️ WARN | [View Details](features/ast-plugin-architecture.md)               |
...
| Zero-Server Deep Traversal               | ⚠️ WARN | [View Details](features/zero-server-deep-traversal.md)            |
| Local Context Compression                | ⚠️ WARN | [View Details](features/local-context-compression.md)             |
| Sub-second Incremental Watch             | ⚠️ WARN | [View Details](features/sub-second-incremental-watch.md)          |
| Headless LSP Manager                     | ⚠️ WARN | [View Details](features/headless-lsp-manager.md)                  |
