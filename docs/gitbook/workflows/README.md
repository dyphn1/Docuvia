...
| ---------------------------------------------------- | --------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [init](init-execution-flow.md)                       | Workspace bootstrap: DB, knowledge branch, AST indexing, agent integrations | 4 — stale `--interactive` flag claim (IFCE-001), stale hydration-gap claim (STOR-002), live `--global` flag despite IFCE-002, MCP entry point bypasses the PLAT-006 command lock |
...
| [analyze](analyze-execution-flow.md)                 | Project-wide config scan, or focused LLM decision extraction                | 1 — LLM-002's "no consumer yet" note is stale                                                                                                                                    |
