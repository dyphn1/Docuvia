...
### Phase 1: Drain the QA Swamp
- **Goal:** Parse all 80+ reports in `docs/roadmap/reports/`, extract all `WARN`, `ERROR`, or unresolved bugs, and forcefully inject them into `docs/roadmap/action_plan_roadmap.md` under a `[CRITICAL BUG FIXES]` section.
