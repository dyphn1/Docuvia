...
| **2.5 Token Limits & Chunking Configs**           | ✅ Done | `[token_management.md](../design/adrs/ADR-009-token-management.md)`                             | Enforce `maxFileSizeKBWarning` in `extension.ts`   |
...
| Task                                              | Status  | Design Spec Anchor                                                                                   | Verification / Evidence                           |
| :------------------------------------------------ | :-----: | :--------------------------------------------------------------------------------------------------- | :------------------------------------------------ |
| **4.1 AST Microkernel & Plugin Ecosystem**        | 🔲 Todo | `[ADR-022-ast-microkernel-architecture.md](../design/adrs/ADR-022-ast-microkernel-architecture.md)`  | Needs `@workspace/plugin-ast-typescript`          |
| **4.2 Zero-Server Deep Traversal & SQLite Cache** | 🔲 Todo | `[ADR-022-ast-microkernel-architecture.md](../design/adrs/ADR-022-ast-microkernel-architecture.md)`  | Needs pure local MCP graph querying               |
...
| **4.6 Sub-second Incremental Watch & Git Hooks**  | 🔲 Todo | `[ADR-022-ast-microkernel-architecture.md](../design/adrs/ADR-022-ast-microkernel-architecture.md)`  | Local fast-path AST hash updates                  |
