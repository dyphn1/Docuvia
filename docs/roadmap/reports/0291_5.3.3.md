...
- `[DEPRECATED_V1_DOC]` — Template management: store and serve prompt templates for L1, L2, L3 generation
- `[DEPRECATED_V1_DOC]` — Per-project template inheritance: projects inherit global defaults, can override at project level
