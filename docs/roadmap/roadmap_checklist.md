...
| SVN integration                                                    | WARN | [ingest.ts](../../artifacts/api-server/src/routes/ingest.ts), [lib/core/src/services/ingestion-pipeline.ts](../../lib/core/src/services/ingestion-pipeline.ts) (see 0701_phase-6_2_1_svn-integration.md)                                                                                                                                                                                                                                           |
...
| Local Context Compression                                                                      | ✅ Done | [`compression.ts`](../../lib/core/src/services/compression.ts), [`generate.ts`](../../artifacts/api-server/src/routes/generate.ts) (Wired into document context pipeline: dedup→sort→truncate→budget assembly, maxTotalChars=6000, maxPerNodeChars=600, compression stats logged)                                                                      |
