...
| SVN integration                                                    | WARN | [673_1.2.5.md](../../reports/673_1.2.5.md) (Architecture drift: diffs stored in message field instead of diff column)                                                                                                                                                                                                                                           |
...
|| [Cross-project linking](../design/adrs/ADR-018-temporal-and-conceptual-bidirectional-linking.md) | ⚠️ WARN | [`generate.ts`](../../artifacts/api-server/src/routes/generate.ts) (detectCrossProjectLinks creates review tasks and graph edges: see 0701_4_1_cross-project-linking.md)                                                                                                                                                                                                                         |
