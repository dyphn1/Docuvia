...
|| [LLM abstraction layer](../design/adrs/ADR-004-openai-compatible-llm-interface-only.md) | ⚠️ WARN | [`integrations-openai-ai-server`](../../lib/integrations-openai-ai-server/) (Only OpenAI supported; see [report 0651_phase-1_llm-abstraction-layer](../../docs/reports/0651_phase-1_llm-abstraction-layer.md)) |
