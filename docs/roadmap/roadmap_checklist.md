...
| [LLM abstraction layer](../design/adrs/ADR-004-openai-compatible-llm-interface-only.md) | ⚠️ WARN | [`integrations-openai-ai-server`](../../lib/integrations-openai-ai-server/) (Only OpenAI supported; see [report 0632_phase-1_llm-abstraction-layer](../../docs/reports/0632_phase-1_llm-abstraction-layer.md)) |
...
| Item                                                                                           | Status                           | Evidence / Verification Target                                                       |
| :--------------------------------------------------------------------------------------------- | :------------------------------- | :----------------------------------------------------------------------------------- |
| [Standalone Engine (Graceful Degradation)](../design/adrs/ADR-002-local-first-architecture.md) | ❌ ERROR                         | [`KnowledgeStore.ts`](../../artifacts/vscode-client/src/KnowledgeStore.ts) (Divergence: currently using legacy YAML, must be refactored to `.docuvia/local.db` SQLite schema. See [report 0626_phase-8_local-sqlite-divergence](../../reports/0626_phase-8_local-sqlite-divergence.md)) |
| [Workspace Onboarding (`/init`)](../design/adrs/ADR-001-vscode-client-onboarding.md)           | ❌ ERROR                         | `extension.ts` (Divergence: `initProject` scaffolds YAML instead of SQLite DB. See [report 0626_phase-8_local-sqlite-divergence](../../reports/0626_phase-8_local-sqlite-divergence.md)) |
...
| Zero-Server Deep Traversal                                                                     | ❌ ERROR                        | Requires pure local SQLite queries (no SQLite in VS Code client; see [report 0626_phase-8_zero-server-deep-traversal](../../reports/0626_phase-8_zero-server-deep-traversal.md)) |
