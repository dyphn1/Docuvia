...
| Zero-Server Deep Traversal                                                                     | ⚠️ WARN                        | [`KnowledgeStore.ts`](../../artifacts/vscode-client/src/KnowledgeStore.ts) (SQLite CTE traversal + in-memory BFS fallback; schema gaps: `l2_nodes` missing `type` column, `node_links` DDL missing; see [report 0637_8.1.1](../../reports/0637_8.1.1.md)) |
