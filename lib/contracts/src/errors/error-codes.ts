...
export const ErrorCodes = {
  ...
  /** Transport-level failure before an HTTP response exists (DNS, refused connection, timeout). */
  LLM_CHAT_COMPLETION_FAILED: "LLM_CHAT_COMPLETION_FAILED",
  /** Non-success HTTP response not covered by a more specific status classification. */
  LLM_HTTP_FAILED: "LLM_HTTP_FAILED",
  ...
  // Semantic decision boundary (#468 / PLAT-011)
  SEMANTIC_CORPUS_LEAKAGE: "SEMANTIC_CORPUS_LEAKAGE",
  SEMANTIC_CORPUS_IO_FAILED: "SEMANTIC_CORPUS_IO_FAILED",
  SEMANTIC_CORPUS_INVALID: "SEMANTIC_CORPUS_INVALID",
  SEMANTIC_INVALID_REQUEST: "SEMANTIC_INVALID_REQUEST",
  SEMANTIC_INVALID_RESPONSE: "SEMANTIC_INVALID_RESPONSE",
  SEMANTIC_INPUT_LIMIT_EXCEEDED: "SEMANTIC_INPUT_LIMIT_EXCEEDED",
  SEMANTIC_CANCELLED: "SEMANTIC_CANCELLED",
  SEMANTIC_DEADLINE_EXCEEDED: "SEMANTIC_DEADLINE_EXCEEDED",
  SEMANTIC_INFERENCE_FAILED: "SEMANTIC_INFERENCE_FAILED",
