 ...
 * running the batch, without importing `lib/core`'s `checkTypeScriptLspPreflight` directly
 * (Virtual Contracts: only ui-core resolves Domain Core capabilities, always by token). Reuses the same
