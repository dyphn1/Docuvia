...
import { OVERLAY_FADE_TRANSITION_CLASSES, OVERLAY_Z_INDEX_CLASS } from "../constants/overlay.js";
...
>(({ className, ...props }, ref) => (
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-[50%] top-[50%] grid w-full max-w-lg translate-x-[-50%] translate-y-[-50%] gap-4 border bg-background p-6 shadow-lg duration-200",
        OVERLAY_Z_INDEX_CLASS,
        OVERLAY_FADE_TRANSITION_CLASSES,
